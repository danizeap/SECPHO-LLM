...
Give SECPHO admins a single, read-only console to review captured chat feedback
and the tool-learning loop, and make the running app's data state observable for
operations via a public health endpoint.
